...
namespace TyreKlicker.API.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<IActionResult> TestLogin(LoginViewModel model, string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
        ...
        [AllowAnonymous]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> TokenLogin([FromBody]LoginModel model, string returnUrl = null)
        {
